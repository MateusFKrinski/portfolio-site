...
$("#education-span").click(function () {
  if ($("#education-content").hasClass("qualification__none")) {
    ...
    $("#work-content").addClass("qualification__none") &&
      $("#work-content").removeClass("qualification__block");
...
$("#work-span").click(function () {
  if ($("#work-content").hasClass("qualification__none")) {
    ...
    $("#education-content").addClass("qualification__none") &&
      $("#education-content").removeClass("qualification__block");
